...
description: 'It seems that Next.js just added export with no intention to work at all, but you can make it work'
date: '2022-11-03'
slug: 'get-next-export-working'
published: true
category: code
tags:
  - nextjs
...
Then everything seems to work as expect until you reload any page which is not the frontpage and the application can't
pickup the routing.
