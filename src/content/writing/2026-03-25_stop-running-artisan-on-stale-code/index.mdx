...
description:
  'A small shell function that warns you when your current directory no longer matches the active deploy. Saved me from debugging phantom issues after a Forge deploy.'
date: '2026-03-25'
