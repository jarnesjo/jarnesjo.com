---
title: Github action and Dockerfile to deploy Next JS with Docker on Digital Ocean
description:
date: '2021-09-20'
published: false
category: code
...
image:
  {
    src: 'card.png',
    alt: 'Text "Github action and Dockerfile to deploy Next JS with Docker on Digital Ocean"'
  }
---
