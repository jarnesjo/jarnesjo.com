  ...
  return (
    <DefaultLayout pageMeta={{title: 'Nicklas Jarnesjö - web, dev and business'}}>
      <div className="py-12 md:py-20">
        <div className="uppercase tracking-wide text-lg font-semibold text-red-600 dark:text-red-500">
      ...
      <div className="pb-20 pt-4">
        ...
        <div className="space-y-5">
          ...
          <div className="font-semibold text-red-600 hover:text-red-700 dark:text-red-500">
