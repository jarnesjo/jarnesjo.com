...
image:
  {
    src: '/static/post-content/format-currency-and-units-with-locale-in-js-with-a-breeze/card.png',
    alt: 'Text "Format currency and units with locale in js with a breeze"'
  }
---
