...
description:
  'Got super weird experience in macOS where the sound drifted to either left or right (and stayed)
  when CPU was under heavy load.'
date: '2020-12-21'
...
image:
  {
    src: '/static/post-content//unbalance-sound-on-mac/card.png',
    alt: 'Text "Unbalance sound on Mac"'
  }
---

<Image
  src={`/static/post-content//unbalance-sound-on-mac/unbalance-sound-mac.png`}
  alt=""
  width={1024}
  height={807}
/>
